      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-4 w-full max-w-md text-gray-500'>
        <div className='flex flex-col gap-1'>
          ...
          <input onChange={(e) => setCourseTitle(e.target.value)}
            type="text"
            value={courseTitle} placeholder='Type here...' className='outline-none md:py-2.5 py-2 px-3 rounded border border-gray-500' required />
        </div>
        <div className='flex flex-col gap-1'>
              ...
              <div className="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50">
                <div className="bg-white text-gray-700 p-4 rounded relative w-full max-w-80">
                  ...
                  <div className="mb-2">
                    <p>Lecture Title</p>
                    <input
                      type="text" className='mt-1 block w-full border rounded py-1 px-2' value={lectureDetails.lectureTitle} onChange={(e) => setLectureDetails({ ...lectureDetails, lectureTitle: e.target.value })} />
                  </div>
                  ...
                  <div className="mb-2">
                    <p>Lecture URL</p>
                    <input
                      type="text" className='mt-1 block w-full border rounded py-1 px-2' value={lectureDetails.lectureUrl} onChange={(e) => setLectureDetails({ ...lectureDetails, lectureUrl: e.target.value })} />
                  </div>
